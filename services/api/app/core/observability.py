...
job_state_transitions_total = Counter(
    "qcp_job_state_transitions_total", "Job state transitions", ["provider", "from_state", "to_state"]
)
provider_errors_total = Counter("qcp_provider_errors_total", "Provider errors by class", ["provider", "error_class"])
poll_cycles_total = Counter("qcp_provider_poll_cycles_total", "Provider poll cycles", ["provider"])
queue_depth_gauge = Gauge("qcp_queue_depth", "Current queue depth")
...
poll_latency_seconds = Histogram("qcp_provider_poll_latency_seconds", "Provider poll latency seconds", ["provider"])
poll_backoff_seconds = Histogram("qcp_provider_poll_backoff_seconds", "Provider poll backoff seconds", ["provider"])
